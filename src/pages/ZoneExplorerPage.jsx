...
const ZoneExplorerPage = () => {
    ...
    return (
        <div className="dashboard-container">
            <Topbar subtitle="Zone Explorer" onMenuClick={() => setSidebarCollapsed(!sidebarCollapsed)} />
            <div className="main-wrapper">
                ...
                <main style={{ flex: 1, overflowY: 'auto', padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    {/* Summary Strip */}
                    <div className="ze-summary" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                    ...
                    {filteredZones.length === 0 ? (
                        ...
                        <div className="ze-table-container">
